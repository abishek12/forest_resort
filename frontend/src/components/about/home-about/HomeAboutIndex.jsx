...
const HomeAboutIndex = () => {
    return (
        <section className='default-padding tw-px-[75px]'>
            ...
            <div className='tw-w-fulll tw-h-[793px] tw-overflow-hidden tw-shadow-lg tw-rounded-lg tw-mt-20 tw-mb-20 '>
                <img src={swim2} alt="swimming pool" className='tw-w-full tw-h-full tw-object-cover hover:tw-scale-105 tw-transition' />
            </div>
            <div className='tw-w-fulll tw-h-[793px] tw-overflow-hidden tw-shadow-lg tw-rounded-lg'>
                <img src={interior} alt="restaurant" className='tw-w-full tw-h-full tw-object-cover hover:tw-scale-105 tw-transition' />
            </div>
        </section>
    )
}
